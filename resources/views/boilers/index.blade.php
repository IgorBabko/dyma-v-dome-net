...
<div class="jumbotron" style="margin: 120px 0 0; background: white">
    <div class="container">
        <div class="row" style="margin-bottom: 100px">
            <h1 style="text-align: left">Котел</h1>
            <p>
            ...
            <p>
                <a class="btn btn-warning btn-lg pull-right" href="/boilers/catalog" role="button">Посмотреть каталог</a>
        ...
        <div class="row">
            <div class="slick-carousel">
                <div>
                    <img src="/images/boilers/one-wall/leyka.jpg">
                </div>
                <div>
                    <img src="/images/boilers/one-wall/podstavka.jpg">
                </div>
                <div>
                    <img src="/images/boilers/one-wall/kagla.jpg">
                </div>
                <div>
                    <img src="/images/boilers/one-wall/leyka.jpg">
                </div>
